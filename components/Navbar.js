...
export default function Navbar({ setMenu, menu }) {
    ...
    return (
        <div className={`sticky top-0 border-b-2 dark:border-[#acadb4] shadow-md  bg-white z-50 dark:bg-slate-900 flex justify-between items-center ${user ? 'px-5' : 'p-4'}`}>
            ...
            <div className='flex  justify-center items-center gap-6'>
                ...
                <div className='relative w-[33px] cursor-pointer' onClick={() => router.push('/buynow')}>
